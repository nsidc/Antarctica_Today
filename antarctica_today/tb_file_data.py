...
if DATA_VERSION == 1:
    ...
    model_results_v1_picklefile = os.path.join(
        model_results_v1_dir, "v1_2000-2020.pickle"
    )
    ...
    outputs_v1_annual_plots_directory = os.path.join(
        model_results_v1_plot_directory, "Cumulative Annual Plots"
    )
    ...
    outputs_v2_annual_plots_directory = os.path.join(
        model_results_v2_plot_directory, "Cumulative Annual Maps"
    )
    model_results_v2_picklefile = os.path.join(
        model_results_v2_dir, "v2_1979-2020.pickle"
    )
    ...
    model_results_v2_5_picklefile = os.path.join(
        model_results_v2_5_dir, "v2.5_1979-2021.pickle"
    )
    ...
    outputs_v2_5_annual_plots_directory = os.path.join(
        model_results_v2_5_plot_directory, "annual_maps"
    )

    v2_5_mean_climatology_tif = os.path.join(
        model_results_v2_5_dir, "mean_climatologies/1989_2020_mean_climatology.tif"
    )
    v2_5_std_climatology_tif = os.path.join(
        model_results_v2_5_dir, "mean_climatologies/1989_2020_std_climatology.tif"
    )
    ...
    aws_validation_plots_directory = os.path.join(
        model_results_v2_5_plot_directory, "aws_validation"
    )
    ...
    gap_filled_melt_picklefile = os.path.join(
        model_results_v2_5_dir, "v2.5_1979_2021_gap_filled.pickle"
    )
    # The percentiles (10,25,50,75,90) saved in a pandas dataframe.
    baseline_percentiles_csv = os.path.join(
        model_results_v2_5_dir, "baseline_percentiles_1989-2020.csv"
    )
    ...
    climatology_plots_directory = os.path.join(
        model_results_v2_5_plot_directory, "climatology"
    )
