...
export ANTARCTICA_TODAY_STORAGE_BASEDIR="/path/to/storage"
```

The storage directory specified here will be used to store large pickle files generated
by this code and imagery generated by this code. In the future, this configurable
storage directory will be used to store all data independently of the code repository.
