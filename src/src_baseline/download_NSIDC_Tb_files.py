...
def main(output_dir=None, credentials=None):
    ...
    cmr_download(url_list, output_dir=output_dir, credentials=credentials)


def read_and_parse_args():
    parser = argparse.ArgumentParser(
        description="Download a time series of NSIDC Tb files."
    )
    parser.add_argument(
        "-output_dir",
        "-o",
        type=str,
        default=".",
        help="Directory in which to download the files.",
    )
    parser.add_argument(
        "-credentials",
        "-c",
        type=str,
        default="",
        help="username:password credentials for the EarthData server.",
    )
    parser.add_argument(
        "-start_date",
        "-s",
        type=str,
        default="",
        help="Start date: [YYYY]-[MM]-[DD]T[HH]:[MM]:[SS]Z (no square brackets)",
    )
    parser.add_argument(
        "-end_date",
        "-e",
...
if __name__ == "__main__":
    ...
    main(output_dir=args.output_dir, credentials=args.credentials)
