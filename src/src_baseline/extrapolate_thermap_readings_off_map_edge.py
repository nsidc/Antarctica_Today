...
thermap_tif_out = os.path.join(os.path.split(thermap_tif)[0], "polar_grid_10m_temps_K_filled_25km_EPSG3412.tif")
...
lines_to_extrapolate_i = [[list(range((86+8),86,-1)), [86,85]],
...
lines_to_extrapolate_j = [[[156] * 8, [156, 156]],
                          [[157] * 8, [157, 157]],
                          [[158] * 8, [158]],
                          [[159] * 8, [159]],
                          [[160] * 8, [160]],
...
for ((known_i, interp_i), (known_j, interp_j)) in zip(lines_to_extrapolate_i, lines_to_extrapolate_j):
...
ds_out = driver.Create(thermap_tif_out, out_array.shape[1],
                                        out_array.shape[0],
                                        1,
                                        tm_datatype)
...
band_out.SetStatistics(numpy.min(out_array_data),
